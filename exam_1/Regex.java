...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Provide the pattern
        pattern = Pattern.compile("[^BTS]{8,}[0-9]$");
        ...
        pattern = Pattern.compile("^(?=.*97)[\\w-\\.]{8,}@gmail\\.com");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("^(http:\\/\\/|https:\\/\\/)?(\\w+\\.)?\\w+\\.(com\\.ph|com)(\\/\\w+)?");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("(http:((//)|(\\\\))+[\\w\\d:#@%/;$()~_?\\+-=\\\\\\.&]*)", " ");
